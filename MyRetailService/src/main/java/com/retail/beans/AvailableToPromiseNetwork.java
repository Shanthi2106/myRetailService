...
public class AvailableToPromiseNetwork {
	...
	public String toString() {
		return "AvailableToPromiseNetwork [productId=" + productId
				+ ", idType=" + idType + ", availableToPromiseQuantity="
				+ availableToPromiseQuantity + ", streetDate=" + streetDate
				+ ", availability=" + availability
				+ ", onlineAvailableToPromiseQuantity="
				+ onlineAvailableToPromiseQuantity
				+ ", storesAvailableToPromiseQuantity="
				+ storesAvailableToPromiseQuantity + ", availabilityStatus="
				+ availabilityStatus + ", multichannelOptions="
				+ multichannelOptions + ", isInfiniteInventory="
				+ isInfiniteInventory + ", loyaltyAvailabilityStatus="
				+ loyaltyAvailabilityStatus + ", loyaltyPurchaseStartDateTime="
				+ loyaltyPurchaseStartDateTime + ", isLoyaltyPurchaseEnabled="
				+ isLoyaltyPurchaseEnabled
				+ ", isOutOfStockInAllStoreLocations="
				+ isOutOfStockInAllStoreLocations
				+ ", isOutOfStockInAllOnlineLocations="
				+ isOutOfStockInAllOnlineLocations + ", additionalProperties="
